...
function fzf_change_directory
    begin
        ...
        ghq root --all | xargs -I {} fd --type d --max-depth 6 --hidden --no-ignore .git {} | sed 's/\/\.git//'
        echo $HOME/.local/share/nvim/lazy | xargs -I {} fd --type d --max-depth 4 --hidden .git {} | sed 's/\/\.git//'
